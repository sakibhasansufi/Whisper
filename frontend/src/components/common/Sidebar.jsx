			...
			<div className='sticky top-0 left-0 h-screen flex flex-col border-r border-gray-700 w-20 md:w-full'>
				...
				<ul className='flex flex-col gap-3 mt-4'>
					<li className='flex justify-center md:justify-start'>
						...
						>
							<MdHomeFilled className={isActive('/') ? 'w-8 h-8 text-[#FF3131]' : 'w-8 h-8 text-secondary'} />
					...
					<li className='flex justify-center md:justify-start'>
						<Link
							...
							className='flex gap-3 items-center hover:bg-stone-700 transition-all rounded-full duration-300 py-2 pl-2 pr-4 max-w-fit cursor-pointer'
						>
							<IoNotifications className={isActive('/notifications') ? 'w-8 h-8 text-[#FF3131]' : 'w-8 h-8 text-secondary'} />
					...
					<li className='flex justify-center md:justify-start'>
						<Link
							...
							className='flex gap-3 items-center hover:bg-stone-700 transition-all rounded-full duration-300 py-2 pl-2 pr-4 max-w-fit cursor-pointer'
						>
							<FaUser className={isActive(`/profile/${authUser?.username}`) ? 'w-8 h-8 text-[#FF3131] ' : 'w-8 h-8 text-secondary'} />
